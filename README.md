...
Announcement copy: [`announcements/jqai-ai-skills-v0.4.1.md`](announcements/jqai-ai-skills-v0.4.1.md)
...
| [`jqai-ai-skills`](https://github.com/jqaisystems/jqai-ai-skills) | Reusable MIT-licensed AI skills for Codex/Claude-style workflows. Start with [`START_HERE.md`](https://github.com/jqaisystems/jqai-ai-skills/blob/main/START_HERE.md), use the root [`INSTALL.md`](https://github.com/jqaisystems/jqai-ai-skills/blob/main/INSTALL.md), or inspect the [`v0.4.1` release](https://github.com/jqaisystems/jqai-ai-skills/releases/tag/v0.4.1). |
