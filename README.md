...
Announcement copy: [`announcements/jqai-ai-skills-v0.4.0.md`](announcements/jqai-ai-skills-v0.4.0.md)
...
| [`jqai-ai-skills`](https://github.com/jqaisystems/jqai-ai-skills) | Reusable MIT-licensed AI skills for Codex/Claude-style workflows. Start with [`START_HERE.md`](https://github.com/jqaisystems/jqai-ai-skills/blob/main/START_HERE.md), inspect the [`v0.4.0` release](https://github.com/jqaisystems/jqai-ai-skills/releases/tag/v0.4.0), or try the [`one-minute install`](https://github.com/jqaisystems/jqai-ai-skills/blob/main/docs/guides/one-minute-install.md). |
