...
Announcement copy: [`announcements/jqai-ai-skills-v0.3.9.md`](announcements/jqai-ai-skills-v0.3.9.md)
...
| [`jqai-ai-skills`](https://github.com/jqaisystems/jqai-ai-skills) | Reusable MIT-licensed AI skills for Codex/Claude-style workflows. Start with the [`v0.3.9` release](https://github.com/jqaisystems/jqai-ai-skills/releases/tag/v0.3.9), try the [`one-minute install`](https://github.com/jqaisystems/jqai-ai-skills/blob/main/docs/guides/one-minute-install.md), or inspect the [`first-run sample`](https://github.com/jqaisystems/jqai-ai-skills/blob/main/docs/examples/first-run-github-safe-publisher.md). |
