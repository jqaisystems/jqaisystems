...
Announcement copy: [`announcements/jqai-ai-skills-v0.3.7.md`](announcements/jqai-ai-skills-v0.3.7.md)
...
| [`jqai-ai-skills`](https://github.com/jqaisystems/jqai-ai-skills) | Reusable MIT-licensed AI skills for Codex/Claude-style workflows. Start with the [`v0.3.7` release](https://github.com/jqaisystems/jqai-ai-skills/releases/tag/v0.3.7), browse the [`catalog`](https://github.com/jqaisystems/jqai-ai-skills/blob/main/docs/catalog.md), or use the [`workflow bundles`](https://github.com/jqaisystems/jqai-ai-skills/blob/main/docs/examples/workflow-bundles.md). |
