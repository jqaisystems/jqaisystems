...
[`jqai-ai-skills v0.5.0`](https://github.com/jqaisystems/jqai-ai-skills/releases/tag/v0.5.0) is the current public skills library release: a validated collection of Codex/Claude-style skill folders with GitHub Actions checks, quick install scripts, categorized README navigation, a top-level Start Here path, a root install command reference, a troubleshooting guide, a root changelog, a root release checklist, a security and responsible-use policy, a public roadmap, support guidance, issue templates, a pull request checklist, a skill quality matrix, a one-minute install guide, a first-run sample for `github-safe-publisher`, a complete public catalog, a first-skill selection guide, workflow bundle examples, stable 2026 social preview, demo media, sample artifacts, and safety-reviewed workflows for publishing, case studies, research brief curation, outreach pipelines, marketplace listings, scraping, skill review, copy cleanup, code deduplication, demo generation, and release announcements.
...
Announcement copy: [`announcements/jqai-ai-skills-v0.5.0.md`](announcements/jqai-ai-skills-v0.5.0.md)
